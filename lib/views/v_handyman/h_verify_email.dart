...
import 'package:sos/views/v_handyman/h_cofirm_code.dart';
import 'package:sos/views/v_handyman/h_login.dart';
import 'package:sos/widgets/myloading.dart';

class HandymanVerifyEmail extends StatefulWidget {
  HandymanVerifyEmail({Key? key}) : super(key: key);

  @override
  _HandymanVerifyEmailState createState() => _HandymanVerifyEmailState();
}

class _HandymanVerifyEmailState extends State<HandymanVerifyEmail> {
  ...
  checkEmail() async {
    ...
    try {
      if (email!.isNotEmpty) {
        Response? response = await sendVerificationCode("hsend_code", email!);
