...
class HandymanReportDialog extends StatefulWidget {
  int userId, requestId;
  HandymanReportDialog({required this.userId, required this.requestId});

  @override
  _HandymanReportDialogState createState() => _HandymanReportDialogState();
}

class _HandymanReportDialogState extends State<HandymanReportDialog> {
